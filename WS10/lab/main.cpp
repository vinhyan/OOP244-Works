...
int main()
{
    ...
    for (ii = 0; ii < 7; ii++) {
        if (find(C, ii, "Hearts")) { //****TODO 1:
            loadCollection(C[ii], cCol2); //****TODO 4:
        }
    }
    ...
    for (ii = 0; ii < 4; ii++) {
        ...
        if (index >= 0) {
            //add the found object at the corresponding index to cCol2. (Review the Collection code for the correct operator) 
            loadCollection(B[index], bCol2);    //****TODO 4:
        }
        else {
    ...
    for (ii = 0; ii < 6; ii++) {
        if (find(P, ii, "Dog")) { //****TODO 1:
            loadCollection(P[ii], pCol2); //****TODO 4:
        }
    }
    ...
    for (ii = 0; ii < 6; ii++) {
        if (find(a, ii, 90)) { //****TODO 1:
            loadCollection(a[ii], iCol); //****TODO 4:
        }
    }
